...
public class Global : Node
{
	...
	public static readonly Array FACTIONColors = new Array(){
	...
	public void _Ready()
	{  
		Config.LoadConfig() ;// initialize with stored settings if available
	...
	{  
		...
		Audio.SetEffectsVolume(Config.effectsVolume);
		Audio.SetVoiceVolume(Config.voiceVolume);
