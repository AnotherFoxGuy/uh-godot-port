...
public class Terrain : TileMap3D
{
	...
	public const var TILESPerAxis = TILESPerSize / 2;
	...
	public PoolVector2Array tileMap
	...
	{  
		...
		var mapSize = GetParent().map_size as int;
	...
	{  
		tileMap = PoolVector2Array();
		foreach(var y in mapSize * TILESPerAxis)
		{
			foreach(var x in mapSize * TILESPerAxis)
			{
